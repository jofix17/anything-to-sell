...
ActiveRecord::Schema[7.2].define(version: 2025_05_09_130946) do
  ...
  create_table "carts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_token", "updated_at"], name: "index_carts_on_guest_token_and_updated_at"
    t.index ["guest_token"], name: "index_carts_on_guest_token", unique: true
    t.index ["user_id", "updated_at"], name: "index_carts_on_user_id_and_updated_at"
  ...
  create_table "order_items", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id", "product_id", "product_variant_id"], name: "index_order_items_on_order_product_and_variant", unique: true
  ...
  create_table "product_images", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "product_images", default: false
    t.boolean "processed", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["processed"], name: "index_product_images_on_processed"
  ...
  create_table "product_property_values", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "property_definition_id"], name: "idx_product_properties"
  ...
  create_table "product_variants", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "is_active", "inventory"], name: "idx_on_product_id_is_active_inventory_cb9af0ce6c"
  ...
  create_table "products", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cached_rating"], name: "index_products_on_cached_rating"
    t.index ["category_id", "cached_rating"], name: "index_products_on_category_id_and_cached_rating"
    t.index ["category_id", "is_active", "status"], name: "index_products_on_category_id_and_is_active_and_status"
    t.index ["category_id"], name: "index_products_on_category_id"
    t.index ["inventory"], name: "index_products_on_inventory"
    t.index ["is_active", "status", "created_at"], name: "index_products_on_is_active_and_status_and_created_at"
    t.index ["name"], name: "index_products_on_name"
    t.index ["sku"], name: "index_products_on_sku"
    t.index ["status"], name: "index_products_on_status"
    t.index ["user_id", "is_active", "status"], name: "index_products_on_user_id_and_is_active_and_status"
  ...
  create_table "reviews", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "status", "created_at"], name: "index_reviews_on_product_id_and_status_and_created_at"
    ...
    t.index ["user_id", "status"], name: "index_reviews_on_user_id_and_status"
    t.index ["user_id"], name: "index_reviews_on_user_id"
  end

  create_table "store_payment_methods", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "stores", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "shipping_methods", default: [], array: true
    ...
    t.index ["vendor_id", "status"], name: "index_stores_on_vendor_id_and_status"
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["status", "created_at"], name: "index_users_on_status_and_created_at"
  end
  ...
  add_foreign_key "store_payment_methods", "payment_methods"
  add_foreign_key "store_payment_methods", "stores"
  add_foreign_key "stores", "users", column: "vendor_id"
