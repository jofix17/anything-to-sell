        ...
        setTimeout(() => {
          ...
          const mockProducts: RelatedProduct[] = [
            ...
            },
            {
              ...
              image: 'https://via.placeholder.com/300x300?text=Wired+Headphones',
              rating: 4.8,
              reviewCount: 65,
              category: 'Electronics',
              vendor: {
            ...
            },
            {
              ...
              price: 39.99,
              image: 'https://via.placeholder.com/300x300?text=Headphone+Adapter',
              rating: 4.1,
              reviewCount: 29,
              category: 'Electronics',
              vendor: {
        ...
        <div key={product.id} className="group relative border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-1 mb-2">
              <StarRating rating={product.rating} size="small" showLabel={false} />
