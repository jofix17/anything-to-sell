...
import { RatingSummary, Review, SortType } from "../../types/review";
          ...
          const mockReviews: Review[] = [
            {
              ...
              comment:
                "These are the best headphones I've ever owned. The sound quality is incredible, and the noise cancellation works perfectly. Battery life is amazing too - I can go days without charging.",
            ...
            },
            {
              ...
              comment:
                "The sound quality is fantastic and I love the features. My only complaint is that they get a bit uncomfortable after wearing them for more than 2 hours. Otherwise, they're nearly perfect.",
            ...
            },
            {
              ...
              comment:
                "Sound quality is decent, but I expected more at this price point. The noise cancellation is just average compared to competitors. Battery life is good though.",
            ...
            },
            {
              ...
              comment:
                "I bought these specifically for long flights, and they've been a game-changer. The noise cancellation blocks out almost all airplane noise, and the battery lasts for multiple long-haul flights.",
            ...
            },
            {
              ...
              comment:
                "While the sound is good, the build quality feels cheap. The plastic creaks and I'm worried about durability. For this price, I expected better construction.",
            ...
            },
            {
              ...
              comment:
                "I debated for months before making this purchase, and I'm so glad I did. The sound quality is exceptional, they're comfortable for all-day wear, and the battery lasts forever. Highly recommended!",
            ...
            },
            {
              ...
              comment:
                "The hardware is fantastic, but the companion app occasionally crashes or fails to connect. Updates have been improving it though, so I'm optimistic.",
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setRatingSummary((prev) => {
          ...
          const newAverage =
            (prev.average * prev.totalCount + userReview.rating) /
            newTotalCount;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center justify-center md:border-r md:border-gray-200 md:pr-8">
          ...
          <span className="text-sm text-gray-500 mt-2">
            ...
            {ratingSummary.totalCount === 1 ? "review" : "reviews"}
          </span>
        </div>
        ...
        <div className="md:col-span-2 space-y-3">
          {[5, 4, 3, 2, 1].map((stars) => (
            <div key={stars} className="flex items-center space-x-2">
              <button
                onClick={() =>
                  handleRatingFilter(filter === stars ? null : stars)
                }
                className={`text-sm w-16 hover:underline ${
                  ...
                  style={{
                    width: `${calculatePercentage(
                      ratingSummary.distribution[
                        stars as keyof typeof ratingSummary.distribution
                      ]
                    )}%`,
                  }}
                />
            ...
            <form onSubmit={handleSubmitReview} className="space-y-4">
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <svg
                        className="w-8 h-8"
                        fill={
                          userReview.rating >= star ? "currentColor" : "none"
                        }
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              {!hasUserPurchased && (
                <p className="text-sm text-red-600 mt-2">
                  Only verified buyers can leave reviews. Purchase this product
                  to leave a review.
                </p>
              )}
            </form>
