                ...
                {showConfirmation ? (
                  ...
                  <div>
                    <p className="text-sm text-amber-600 font-semibold mb-4">
                      This action will remove all {userItemCount} items from
                      your current cart. Are you sure you want to replace them
                      with {guestItemCount} items from your guest cart?
                    </p>
                  ...
                  <>
                    <p className="text-sm text-gray-500 mb-4">
                      We found items in two different shopping carts. How would
                      you like to handle them?
                    </p>
