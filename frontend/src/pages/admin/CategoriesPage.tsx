...
const AdminCategoriesPage: React.FC = () => {
  ...
  const [confirmDelete, setConfirmDelete] = useState<{ open: boolean; categoryId: string | null }>({ 
    open: false, 
    categoryId: null 
  });
  ...
  const handleCreateCategory = async (values: any) => {
    try {
      ...
      if (values.parentId) {
        categoryData.parentId = parseInt(values.parentId);
      }
  ...
  const handleUpdateCategory = async (values: any) => {
    ...
    try {
      ...
      if (values.parentId !== undefined) {
        categoryData.parentId = values.parentId ? parseInt(values.parentId) : null;
      }
      ...
      const updatedCategory = await adminService.updateCategory(selectedCategory.id, categoryData);
  ...
  const CategoryTreeItem: React.FC<{ 
    ...
    return (
      <div className="category-item">
        <div 
          className={`flex items-center py-3 px-3 ${level > 0 ? 'ml-6' : ''} hover:bg-gray-50`}
          ...
          {hasChildren && (
            ...
            >
              <svg
                ...
                className={`h-5 w-5 transform ${expanded ? 'rotate-90' : ''} transition-transform duration-200`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Notification */}
      {notification && (
        <div className={`mt-6 ${notification.type === 'success' ? 'bg-green-50' : 'bg-red-50'} p-4 rounded-md`}>
          <div className="flex">
            ...
            <div className="ml-3 flex-1">
              ...
              <div className="mt-2">
                <button
                  type="button"
                  className={`text-sm font-medium ${notification.type === 'success' ? 'text-green-700 hover:text-green-600' : 'text-red-700 hover:text-red-600'}`}
                ...
                {({ isSubmitting: formSubmitting }) => (
                  <Form>
                                ...
                                <div className="ml-4">
                                  <div className="relative bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm flex items-center cursor-pointer hover:bg-gray-50 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                    ...
                                    >
                                      ...
                                      <span className="sr-only"> category image</span>
                                    </label>
                                    <input
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                      ...
                      >
                        {isSubmitting ? 'Saving...' : modalMode === 'create' ? 'Add Category' : 'Update Category'}
                      </button>
                      <button
                        type="button"
                        onClick={closeModal}
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete this category? This action cannot be undone. All products in this category will need to be reassigned.
                      </p>
                    </div>
                  </div>
                </div>
